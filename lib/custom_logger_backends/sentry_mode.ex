defmodule LogCake.CustomLoggerBackends.SentryMode do
  ...
  def handle_event(
    ...
    # IO.inspect(msg, label: "msg123")
    IO.inspect(level, label: "vai ca level")
...
#   def test_crash do
#     raise "bo may thich thi bo may raise day dmm"
#   end

#   @impl true
#   def init(__MODULE__) do
#     # IO.inspect("im fucking here1")
#     # config = Application.get_env(:logger, __MODULE__)
#     # IO.inspect("im fucking 2")
#     # device = Keyword.get(config, :device, :user)
#     # IO.inspect("im fucking 3")

#     # if Process.whereis(device) |> IO.inspect(label: "vai ca loz") do
#     #   {:ok, init(config, %__MODULE__{})}
#     # else
#     #   {:error, :ignore}
#     # end
#     IO.inspect("im here 1")
#     {:ok, %__MODULE__{}}
#   end
...
#   @impl true
#   def handle_call({:configure, options}, state) do
#     IO.inspect(options, label: "options222")
#     IO.inspect(state, label: "state222")
#     {:ok, :ok, configure(options, state)}
#   end

#   @impl true
#   def handle_event({level, _gl, {Logger, msg, ts, md}}, state) do
#     IO.inspect(level, label: "level123")
#     IO.inspect(msg, label: "msg123")
#     IO.inspect(ts, label: "ts123")
#     IO.inspect(md, label: "md123")
#     IO.inspect(state, label: "state123")
...
#     metadata = Keyword.get(config, :metadata, []) |> configure_metadata() |> IO.inspect(label: "metadata123")
...
#     IO.inspect(state, label: "state123123")
#     format
#     |> IO.inspect(label: "dit con me cuoc doi")
